                            ...
                            <div class="container my-4">
                                <x-form.row-col>
                                    <x-slot name="first">
                                        ...
                                        <x-form.label class="mt-4" name="educational_attainment (College)"/>
                                    ...
                                    <x-slot name="second">
                                        ...
                                        <x-form.label class="mt-4" name="city"/>
...
<script>
    ...
    div.addEventListener('change', (e) => {
        ...
        if(year < 16){
            birthDate.classList = 'border-danger shadow-sm form-control text-danger'
